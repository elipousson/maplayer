...
#' generated by an equivalent of [purrr::map()]) and create multiple files using
#' the same parameters or use the {gridExtras} package to create a single
#' combined PDF file.
#'
...
#' @param quiet If `TRUE`, suppress informational messages. Defaults to `FALSE`.
